    ...
    <div className="bg-white text-gray-900 font-sans">
      ...
      <main className="container mx-auto p-6 max-w-6xl">
        ...
        <section className="my-20 flex flex-col md:flex-row items-center gap-12">
          <img src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80&fm=webp" 
          alt="Reforestation" 
          loading="lazy"
          decoding="async"
        ...
        <section className="bg-gradient-to-br from-green-50 to-green-100 p-12 rounded-xl shadow-lg my-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1748&q=80&fm=webp" 
              alt="Biodiversity" 
              loading="lazy"
              decoding="async"
              className="mx-auto rounded-lg shadow-md h-48 w-full object-cover" />
            ...
            <div className="text-center bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1732&q=80&fm=webp" 
              alt="Community" 
              loading="lazy"
              decoding="async"
              className="mx-auto rounded-lg shadow-md h-48 w-full object-cover" />
            ...
            <div className="text-center bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <img src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1748&q=80&fm=webp" 
              alt="Climate Change" 
              loading="lazy"
              decoding="async"
              className="mx-auto rounded-lg shadow-md h-48 w-full object-cover" />
